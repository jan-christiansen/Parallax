...
var Parallax$movableClass = new Fay$$$(function(){
  return Fay$$list(".movable");
});
var Parallax$navItemClass = new Fay$$$(function(){
  return Fay$$list(".navItem");
});
var Parallax$scrollPositionData = new Fay$$$(function(){
  return Fay$$list("scrollpos");
});
var Parallax$speedData = new Fay$$$(function(){
  return Fay$$list("speed");
});
var Parallax$offsetData = new Fay$$$(function(){
  return Fay$$list("offset");
});
var Parallax$visibilityData = new Fay$$$(function(){
  return Fay$$list("vis");
});
var Parallax$endYData = new Fay$$$(function(){
  return Fay$$list("end");
});
var Parallax$startYData = new Fay$$$(function(){
  return Fay$$list("start");
});
var Parallax$main = new Fay$$$(function(){
  return Fay$$_(Fay$$_(JQuery$documentReady)(Parallax$onReady))(Parallax$document);
});
var Parallax$onReady = function($p1){
  return new Fay$$$(function(){
    return (function(){
      var scrollSpeed = 0.5;
      return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(Parallax$$_window)))(function($p1){
        var win = $p1;
        return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$scroll)(Parallax$onScroll))(win)))(Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Parallax$triggerScroll)(win)))(Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$select)(Parallax$navItemClass)))(function($p1){
          var navItemEvents = $p1;
          return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$each)(Fay$$_(Parallax$addScrollAnimation)(scrollSpeed)))(navItemEvents)))(Fay$$_(Fay$$$_return)(Fay$$unit));
        })));
      });
    })();
  });
};
var Parallax$addScrollAnimation = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
        var element = $p3;
        var scrollSpeed = $p1;
        return (function(){
          var onClick = function($p1){
            return new Fay$$$(function(){
              return Fay$$_(Fay$$_(Fay$$bind)(Parallax$body))(function($p1){
                var bodyElem = $p1;
                return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$getScrollTop)(bodyElem)))(function($p1){
                  var oldPosition = $p1;
                  return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
                    var object = $p1;
                    return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(Parallax$getDataDouble)(Parallax$scrollPositionData))(object)))(function($p1){
                      var position = $p1;
                      return (function(){
                        var duration = new Fay$$$(function(){
                          return Fay$$_(Fay$$_(Fay$$mult)(Fay$$_(Prelude$abs)(Fay$$_(Fay$$_(Fay$$sub)(oldPosition))(position))))(scrollSpeed);
                        });
                        return Fay$$_(Fay$$_(Fay$$_(Parallax$animateScrollTop)(position))(duration))(bodyElem);
                      })();
                    });
                  });
                });
          ...
          return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(Fay$$_(JQuery$click)(onClick))))(Fay$$_(Fay$$$_return)(true));
        })();
      });
    };
  };
};
var Parallax$onScroll = function($p1){
  return new Fay$$$(function(){
    return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(Parallax$$_window)))(function($p1){
      var win = $p1;
      return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$getScrollTop)(win)))(function($p1){
        var pos = $p1;
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$select)(Parallax$movableClass)))(function($p1){
          var movableObjects = $p1;
          return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$each)(Fay$$_(Parallax$placeElement)(pos)))(movableObjects)))(Fay$$_(Fay$$$_return)(Fay$$unit));
        });
      });
    });
  });
};
var Parallax$Always = new Fay$$$(function(){
  return new $_Parallax$Always();
});
var Parallax$Range = function(slot1){
  return function(slot2){
    return new Fay$$$(function(){
      return new $_Parallax$Range(slot1,slot2);
    });
  };
};
var Parallax$movement = function($p1){
  return function($p2){
    return function($p3){
      return function($p4){
        return new Fay$$$(function(){
          ...
          var c = $p3;
          var speed = $p2;
          if (Fay$$_($p1) instanceof $_Parallax$Always) {
            return Fay$$_(Prelude$Just)(Fay$$_(Fay$$_(Fay$$add)(Fay$$_(Fay$$_(Fay$$mult)(speed))(y)))(c));
          }
          var y = $p4;
          var c = $p3;
          var speed = $p2;
          if (Fay$$_($p1) instanceof $_Parallax$Range) {
            var startY = Fay$$_($p1).slot1;
            var endY = Fay$$_($p1).slot2;
            if (Fay$$_(Fay$$_(Fay$$_(Fay$$and)(Fay$$_(Fay$$_(Fay$$gte)(y))(startY)))(Fay$$_(Fay$$_(Fay$$lte)(y))(endY)))) {
              return Fay$$_(Prelude$Just)(Fay$$_(Fay$$_(Fay$$add)(Fay$$_(Fay$$_(Fay$$mult)(speed))(y)))(c));
            } else {if (true) {
                return Prelude$Nothing;
              }
          ...
          throw ["unhandled case in movement",[$p1,$p2,$p3,$p4]];
        });
      };
    };
  };
};
var Parallax$placeElement = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
        var element = $p3;
        ...
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery$selectElement)(element)))(function($p1){
          var object = $p1;
          return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(Parallax$getDataDouble)(Parallax$speedData))(object)))(function($p1){
            var speed = $p1;
            return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(Parallax$getDataDouble)(Parallax$offsetData))(object)))(function($p1){
              var offset = $p1;
              return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Parallax$getVisibility)(object)))(function($p1){
                var vis = $p1;
                return Fay$$_(Fay$$_(Fay$$then)((function($tmp1){
                  if (Fay$$_($tmp1) instanceof $_Prelude$Nothing) {
                    return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$hide)(JQuery$Instantly))(object)))(Fay$$_(Fay$$$_return)(Fay$$unit));
                  }
                  if (Fay$$_($tmp1) instanceof $_Prelude$Just) {
                    var y = Fay$$_($tmp1).slot1;
                    return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery$jshow)(JQuery$Instantly))(object)))(Fay$$_(Fay$$_(Parallax$setPositionY)(y))(object));
                  }
                  return (function(){ throw (["unhandled case",$tmp1]); })();
                })(Fay$$_(Fay$$_(Fay$$_(Fay$$_(Parallax$movement)(vis))(speed))(offset))(yPos))))(Fay$$_(Fay$$$_return)(true));
              });
            });
          });
        });
...
var Parallax$getVisibility = function($p1){
  return new Fay$$$(function(){
    var obj = $p1;
    return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(Parallax$getData)(Parallax$visibilityData))(obj)))(function($p1){
      var visibility = $p1;
      return (function($tmp1){
        if (Fay$$equal($tmp1,Fay$$list("always"))) {
          return Fay$$_(Fay$$$_return)(Parallax$Always);
        }
        if (Fay$$equal($tmp1,Fay$$list("range"))) {
          return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(Parallax$getDataDouble)(Parallax$startYData))(obj)))(function($p1){
            var start = $p1;
            return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(Parallax$getDataDouble)(Parallax$endYData))(obj)))(function($p1){
              var end = $p1;
              return Fay$$_(Fay$$$_return)(Fay$$_(Fay$$_(Parallax$Range)(start))(end));
            });
          });
        }
        return (function(){ throw (["unhandled case",$tmp1]); })();
...
var Parallax$getData = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay_string(Fay$$fayToJs(["user","JQuery",[]],$p2).data(Fay$$fayToJs_string($p1))));
    });
  };
};
var Parallax$getDataDouble = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay_double(Fay$$fayToJs(["user","JQuery",[]],$p2).data(Fay$$fayToJs_string($p1))));
    });
  };
};
var Parallax$setPositionY = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["unknown"],Fay$$fayToJs(["user","JQuery",[]],$p2).css("top", Fay$$fayToJs_double($p1))));
    });
  };
};
var Parallax$animateScrollTop = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
        return new Fay$$Monad(Fay$$jsToFay(["unknown"],Fay$$fayToJs(["user","JQuery",[]],$p3).animate({'scrollTop': Fay$$fayToJs_double($p1)}, Fay$$fayToJs_double($p2))));
      });
    };
  };
};
var Parallax$triggerScroll = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay(["unknown"],Fay$$fayToJs(["user","JQuery",[]],$p1)['trigger']('scroll')));
  });
};
var Parallax$body = new Fay$$$(function(){
  return Fay$$_(JQuery$select)(Fay$$list("body"));
});
var Parallax$$_window = new Fay$$$(function(){
  return Fay$$jsToFay(["user","Element",[]],window);
});
var Parallax$document = new Fay$$$(function(){
  return Fay$$jsToFay(["user","Document",[]],document);
});
...
var $_Parallax$Always = function(){
};
var $_Parallax$Range = function(slot1,slot2){
  this.slot1 = slot1;
  this.slot2 = slot2;
};
var Fay$$fayToJsUserDefined = function(type,obj){
  ...
  if (_obj instanceof $_Parallax$Always) {
    var obj_ = {"instance": "Always"};
    return obj_;
  }
  if (_obj instanceof $_Parallax$Range) {
    var obj_ = {"instance": "Range"};
    var obj_slot1 = Fay$$fayToJs_double(_obj.slot1);
    if (undefined !== obj_slot1) {
      obj_['slot1'] = obj_slot1;
    }
    var obj_slot2 = Fay$$fayToJs_double(_obj.slot2);
    if (undefined !== obj_slot2) {
      obj_['slot2'] = obj_slot2;
    }
    return obj_;
...
var Fay$$jsToFayUserDefined = function(type,obj){
  ...
  if (obj["instance"] === "Always") {
    return new $_Parallax$Always();
  }
  if (obj["instance"] === "Range") {
    return new $_Parallax$Range(Fay$$jsToFay_double(obj["slot1"]),Fay$$jsToFay_double(obj["slot2"]));
  }
  return obj;
};

// Exports
this.Parallax$Always = Parallax$Always;
this.Parallax$Range = Parallax$Range;
this.Parallax$addScrollAnimation = Parallax$addScrollAnimation;
this.Parallax$animateScrollTop = Parallax$animateScrollTop;
this.Parallax$body = Parallax$body;
this.Parallax$document = Parallax$document;
this.Parallax$endYData = Parallax$endYData;
this.Parallax$getData = Parallax$getData;
this.Parallax$getDataDouble = Parallax$getDataDouble;
this.Parallax$getVisibility = Parallax$getVisibility;
this.Parallax$main = Parallax$main;
this.Parallax$movableClass = Parallax$movableClass;
this.Parallax$movement = Parallax$movement;
this.Parallax$navItemClass = Parallax$navItemClass;
this.Parallax$offsetData = Parallax$offsetData;
this.Parallax$onReady = Parallax$onReady;
this.Parallax$onScroll = Parallax$onScroll;
this.Parallax$placeElement = Parallax$placeElement;
this.Parallax$scrollPositionData = Parallax$scrollPositionData;
this.Parallax$setPositionY = Parallax$setPositionY;
this.Parallax$speedData = Parallax$speedData;
this.Parallax$startYData = Parallax$startYData;
this.Parallax$triggerScroll = Parallax$triggerScroll;
this.Parallax$visibilityData = Parallax$visibilityData;
this.Parallax$$_window = Parallax$$_window;
...
;
var main = new Parallax();
main._(main.Parallax$main);
